...
```{r}
pacman::p_load(readr, ggrepel, patchwork, Hmisc, ggthemes, hrbrthemes, ggstatsplot, ggiraph, plotly, dplyr, patchwork, DT, tidyverse, ggplot2, stats, ggridges, viridis, scales, cowplot, ggdist, tidyquant, ggthemes)
```
...
Joined_data %>%
  ...
  theme_minimal() +
  theme(axis.text.y = element_blank(), axis.title.y = element_blank(), legend.position = "right") +
...
```
For Visualisation ease, values > 15000 for Wage have been obscured through limiting of the graph's axis. 
